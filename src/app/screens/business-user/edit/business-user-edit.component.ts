...
export class BusinessUserEditComponent implements OnInit {
  ...
  editMember() {
    ...
    this.businessUserService.editBusinessuser(this.entityData)
    .subscribe({
      next: (response) => {
        this.dismissAlert();
        this.spinnerService.hide();   
        this.alertMessage.SuccessMessage = "Member details updated successfully."
        this.getMember();  
       },
      error: (error) => {
        this.spinnerService.hide();
        this.alertMessage.ErrorMessage = "Failed to update member.";
        this.resetAlert();
      }
    });
  }
  ...
  getMember() {
    this.spinnerService.show();
    this.businessUserService.getBusinessuser(this.businessUserId)
    .subscribe({
      next: (response) => {
      ...
      error: (error) => {
        this.spinnerService.hide();
        this.alertMessage.ErrorMessage = "Failed to get member details.";
        this.resetAlert();
      }
    });
  }
